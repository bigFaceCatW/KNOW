 ...
 * 
 * @author lmwang 创建时间：2014-7-14 上午10:16:15
 */
public class ConfigTypeUtil {
	public static final Logger logger = LoggerFactory.getLogger(ConfigTypeUtil.class);
	// 初始化配置文件
	private static String[] configfile = { "localconfig.properties"};
